...
module.exports = function (pic) {
    return (0, _yoYo2.default)(_templateObject, pic.url, pic.user.username, pic.user.avatar, pic.user.username, pic.likes);
};
